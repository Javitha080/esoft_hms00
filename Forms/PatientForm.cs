...
namespace HospitalManagementSystem.Forms
{
    ...
    public partial class PatientForm : Form
    {
        ...
        {
            // Set form properties
            Text = "Patient Registration"; // Form title
            Size = new Size(700, 500); // Form size (width, height)
            ...
            Controls.Add(lblName); // Add label to form
            Controls.Add(txtName); // Add textbox to form

            // Age Label and TextBox
            Label lblAge = new Label() { Text = "Age:", Location = new Point(20, 50), Size = new Size(80, 20) };
            txtAge = new TextBox() { Location = new Point(100, 50), Size = new Size(200, 20) };
            ...
            Label lblGender = new Label() { Text = "Gender:", Location = new Point(20, 80), Size = new Size(80, 20) };
            cmbGender = new ComboBox() { Location = new Point(100, 80), Size = new Size(200, 20), DropDownStyle = ComboBoxStyle.DropDownList };
            ...
            Label lblPhone = new Label() { Text = "Phone:", Location = new Point(20, 110), Size = new Size(80, 20) };
            txtPhone = new TextBox() { Location = new Point(100, 110), Size = new Size(200, 20) };
            ...
            Label lblAddress = new Label() { Text = "Address:", Location = new Point(20, 140), Size = new Size(80, 20) };
            txtAddress = new TextBox() { Location = new Point(100, 140), Size = new Size(200, 20) };
            ...
            btnAdd = new Button() { Text = "Add Patient", Location = new Point(100, 180), Size = new Size(100, 30) };
            ...
            btnUpdate = new Button() { Text = "Update", Location = new Point(210, 180), Size = new Size(90, 30) };
            ...
            btnDelete = new Button() { Text = "Delete", Location = new Point(310, 180), Size = new Size(90, 30) };
            ...
            btnClear = new Button() { Text = "Clear", Location = new Point(410, 180), Size = new Size(90, 30) };
            ...
            dgv = new DataGridView() { Location = new Point(20, 230), Size = new Size(650, 220) };
